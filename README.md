...
[![Build Status](https://travis-ci.org/mygroup/rug-test-2.svg?branch=master)](https://travis-ci.org/mygroup/rug-test-2)
...
```
$ cd to/the/repo
$ rug edit mygroup:rug-test-2:AddReadme \
...
[issue]: https://github.com/mygroup/rug-test-2/issues
